...
- Vault History - same columns as current, and filtered by date as current. It may be worth adding a note to remind users that using the filename filter will be very helpful here.
